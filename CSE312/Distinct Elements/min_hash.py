# UW CSE 312, PSet #6 Spring 2024
# Student Name: Ataberk Yildiz
# Email    : ayildiz@uw.edu
...
class MultMinHash:
    ...
    def estimate(self) -> int:
        ...
        if not self.des:
            return 0
        avgerage_min = np.mean([de.val for de in self.des])
        if avgerage_min == 0:
            return 0
        return int(1 / avgerage_min - 1)
